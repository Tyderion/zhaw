...
static uint8_t init_terminal(void);

/*
 * according to description in header file
 */
uint8_t cmd_lcd_clear_display(void)
{
    ...
    return lcd_io_write_cmd_to_display(cmd_buffer, 2);
}

/*
 * according to description in header file
 */
uint8_t cmd_lcd_init_display(void)
{
    lcd_io_init_display_interface();
    init_terminal();
    cmd_lcd_set_display_color(COLOR_BLACK, COLOR_BLACK);
    cmd_lcd_set_font_zoom_factor(1, 1);
 ...
 * according to description in header file
 */
uint8_t cmd_lcd_set_display_font(uint8_t font_number)
{
    uint8_t cmd_buffer[10];
    ...
    return lcd_io_write_cmd_to_display(cmd_buffer, 3);
}

/*
 * according to description in header file
 */
uint8_t cmd_lcd_print_text_on_display(uint16_t x_position,
                              uint16_t y_position, uint8_t text[])
{
    ...
    return lcd_io_write_cmd_to_display(cmd_buffer, i + 7);
}

/*
 * according to description in header file
 */
uint8_t cmd_lcd_set_font_zoom_factor(uint8_t x_zoom_factor,
                             uint8_t y_zoom_factor)
{
    ...
    return lcd_io_write_cmd_to_display(cmd_buffer, 4);
}

/*
 * according to description in header file
 */
uint8_t cmd_lcd_set_font_color(uint8_t font_color,
                       uint8_t background_color)
{
    uint8_t cmd_buffer[10];

    // accept only values supported by display
    if (font_color > 32 || background_color > 32) {     //|| backgroundColor == 0
        return 1;
    }
 ...
 * according to description in header file
 */
uint8_t cmd_lcd_set_display_color(uint8_t font_color,
                          uint8_t background_color)
{
    uint8_t cmd_buffer[10];
 ...
 * according to description in header file
 */
uint8_t cmd_lcd_fill_area(uint16_t left, uint16_t top,
                  ...
                  uint8_t fill_color)
{
    ...
    return lcd_io_write_cmd_to_display(cmd_buffer, 11);
}

/*
 * according to description in header file
 */
uint8_t cmd_lcd_set_cursor_on_off(uint8_t on_off)
{
    uint8_t cmd_buffer[10];
